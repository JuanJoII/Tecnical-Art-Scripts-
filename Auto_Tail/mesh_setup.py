...
def tail_mesh_setup():
    ...
    cylinder = cmds.polyCylinder(radius=1, height=2, subdivisionsAxis=8, subdivisionsHeight=1, subdivisionsCaps=1, axis=(0, 1, 0), roundCap=False, constructionHistory=True, name='pCylinder1')[0]
    ...
    print(f"Caras inferiores seleccionadas")
    ...
    if cmds.objExists(dynamic_curve):
        ...
        try:
            ...
            print(f"Divisiones ajustadas a 15, taper ajustado a 0.1")
    ...
    print(f"Transformaciones freezeadas")
    
    cmds.delete(cylinder, constructionHistory=True)
    print(f"Historial borrado")
