...
def hair_rigging_setup():
    ...
    for curve in curves:
        if curve == 'curve1':
            ...
            print(f"Curva renombrada a: dynamic_cv_002")
            curve1_found = True
            break
    ...
    try:
        ...
        joint_pos = cmds.xform(first_joint, query=True, worldSpace=True, translation=True)
